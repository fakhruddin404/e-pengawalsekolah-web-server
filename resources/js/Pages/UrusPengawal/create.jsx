...
export default function Create({ auth, nextId }) {
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            setData('fld_pgw_urlGambarWajah', null);
            setPreview(null);
        }
    };
    ...
    const submit = (e) => {
        ...
        transform((data) => {
            ...
            // Jika nombor bermula dengan '0', potong '0' tu
            ...
            return {
                ...data,
                fld_pgw_noTelefon: '+60' + nomborDitaip,
            };
        });

        // Gunakan post kerana ini adalah Create (tidak perlu spoofing method)
        post(route('pentadbir.pengawal.store'), {
            forceFormData: true, // Penting untuk muat naik fail
    ...
    return (
        <PentadbirLayout
            ...
            breadcrumbs={[
                ...
                { label: 'Create Pengawal' }
            ]}
        >
            <Head title="Pendaftaran Pengawal" />

            <div className="w-full space-y-6">

                <div className="flex justify-between items-center">
                    <div className="flex flex-col">
                        <h2 className="text-xl font-bold text-gray-900">Pendaftaran Akaun Pengawal Baru</h2>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            {/* ID Pengawal */}
                            <div>
                                <InputLabel htmlFor="fld_pgw_id" value="ID Pengawal (Janaan Automatik)" />
                                <TextInput
                                    id="fld_pgw_id"
                                    type="text"
                                    name="fld_pgw_id"
                            ...
                            <div>
                                ...
                                <TextInput
                                    ...
                                    placeholder="Cth: 999999-99-9999"
                                    maxLength="14"
                                    required
                                />
                            ...
                            <div className="relative">
                                ...
                                <div className="flex gap-2.5 mt-1">
                                    ...
                                    <TextInput
                                        ...
                                        placeholder="123456789 (Tanpa tanda '-')"
                                        required
                                    />
                                </div>
                            ...
                            {/* Status */}
                            <div>
                                <InputLabel htmlFor="fld_pgw_status" value="Status" />
                                <select
                                    id="fld_pgw_status"
                                    name="fld_pgw_status"
                                    value={data.fld_pgw_status}
                                    ...
                                    onChange={(e) => setData('fld_pgw_status', e.target.value)}
                                    required
                                >
                                    <option value="aktif">Aktif</option>
                                    <option value="tidak_aktif">Tidak Aktif</option>
                                </select>
                                <InputError message={errors.fld_pgw_status} className="mt-2" />
                            </div>

                            {/* Gambar Peribadi */}
                            <div className="space-y-2 col-span-1 md:col-span-2">
                                <InputLabel htmlFor="fld_pgw_urlGambarWajah" value="Gambar Peribadi (Pilihan)" />
